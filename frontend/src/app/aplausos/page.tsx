...
export default function ApplausePage() {
  ...
  useEffect(() => { setProducts([...demoProducts, ...readProducts()]); setFavoriteIds(readFavoriteIds()); }, []);
