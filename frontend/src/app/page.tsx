...
export default function HomePage() {
	return (
		<main className="page-shell home-page">
			<header className="topbar"><a className="brand-link" href="/"><img className="header-logo" src="/artpop_restaurada_alta_resolucao.png" alt="Logomarca artpop" /></a><nav><a href="/produtos">Ver vitrine</a><a href="/painel-artesao">Área do artesão</a><span className="avatar">AL</span></nav></header>
