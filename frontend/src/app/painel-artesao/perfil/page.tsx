...
export default function ArtisanProfilePage() {
  return (
    <main className="page-shell">
      <header className="topbar"><a className="brand-link" href="/"><img className="header-logo" src="/artpop_restaurada_alta_resolucao.png" alt="Logomarca artpop" /></a><nav><a href="/painel-artesao">Meus produtos</a><a href="/artesoes">Ver perfil público</a><span className="avatar">AL</span></nav></header>
