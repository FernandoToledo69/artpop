...
export default function CarrinhoPage() {
	...
	return (
		<main className="page-shell cart-page">
			...
			<section className="cart-intro"><div><p className="eyebrow">SEU PEDIDO</p><h1>Seu <em>carrinho</em></h1><p className="intro-copy">Revise suas escolhas e confira o custo total para receber suas obras.</p></div><span className="cart-count">{cartItems.length} {cartItems.length === 1 ? 'obra' : 'obras'}</span></section>
